...
namespace ConsoleAdventure.Content.Scripts
{
    ...
    /// источник: <see href="https://gist.github.com/KdotJPG/b1270127455a94ac5d19"/>
    /// </summary>
    public class OpenSimplex
    {
        ...
        private static readonly double FALLBACK_ROTATE3 = 2.0 / 3.0;
        private static readonly double ROTATE3_ORTHOGONALIZER = UNSKEW_2D;

        private static readonly float UNSKEW_4D = -0.138196601125011f;
        ...
        private static readonly double NORMALIZER_2D = 0.05481866495625118;
        private static readonly double NORMALIZER_3D = 0.2781926117527186;

        private static readonly float RSQUARED_2D = 2.0f / 3.0f;
        private static readonly float RSQUARED_3D = 3.0f / 4.0f;
        ...
        private static readonly int[] LOOKUP_4D_A;
        ...
        private class LatticeVertex4D
        {
            ...
            public long xsvp, ysvp, zsvp, wsvp;
